...
export default function Chat() {
    ...
    useEffect(() => {
        ...
        const theElement = document.getElementById("base-input");
    ...
    const sendMessage = async (message, _bot) => {
        ...
        if (message.length < 1 || message.length > 2000) return setLoading(false);
        ...
        try {
            ...
            actualMessage.data = actualMessage.data.replace(/AI:/g, "");
                ...
                <div className="flex gap-3 items-center md3x:flex-col">
                    ...
                    <div className="flex flex-col mb-1">
                        ...
                        <p className="text-gray-400 md3x:text-center">
                            Savol yoki muommolaringizni sun'iy aqldan so'rang!
                        </p>
                    </div>
                </div>
