...
export default function Pricing() {
    return (
        <div className="w-full overflow-x-hidden min-h-screen bg-gradient-to-br from-purple-600 to-indigo-900">
            <PageNavbar />
            <section className=" dark:bg-gray-900 mt-8 mb-12">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                        <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800">
                            ...
                            <Link
                                to="#"
                                className="text-gray-300 bg-indigo-600 transition shadow-lg hover:bg-indigo-500 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center  "
                            >
                                Get started
                            </Link>
                        </div>
